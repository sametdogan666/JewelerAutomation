...
namespace JewelerAutomation.Infrastructure.Migrations
{
    ...
    [Migration("20260404232509_SahisEmanetOpeningBalance")]
    partial class SahisEmanetOpeningBalance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JewelerAutomation.Core.Entities.CustomerTransaction", b =>
                {
                    ...
                    b.Property<int?>("OpeningAssetKind")
                        .HasColumnType("integer");

                    b.Property<bool?>("OpeningCustomerIsCreditor")
                        .HasColumnType("boolean");

                    b.Property<bool>("PostToLedger")
                        .HasColumnType("boolean");

                    b.Property<Guid?>("SourceBasketTransactionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SourceBasketTransactionId");
            ...
            modelBuilder.Entity("JewelerAutomation.Core.Entities.Transaction", b =>
                {
                    ...
                    b.Property<decimal?>("ForexAmountBase")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<int?>("ForexBaseCurrency")
                        .HasColumnType("integer");

                    b.Property<decimal?>("ForexCounterTry")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<bool?>("ForexIsBuy")
                        .HasColumnType("boolean");

                    b.Property<decimal?>("ForexRateTryPerUnit")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");
                    ...
                    b.Property<bool>("IsSahisEmanet")
                        .HasColumnType("boolean");

                    b.Property<bool>("KasaHareketli")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal>("NetCashAmountEur")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<decimal>("NetCashAmountGbp")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");

                    b.Property<decimal>("NetCashAmountUsd")
                        .HasPrecision(18, 6)
                        .HasColumnType("numeric(18,6)");
                    ...
                    b.Property<int>("SahisEmanetMode")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("JewelerAutomation.Core.Entities.CustomerTransaction", b =>
                {
                    ...
                    b.HasOne("JewelerAutomation.Core.Entities.Transaction", "SourceBasketTransaction")
                        .WithMany()
                        .HasForeignKey("SourceBasketTransactionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Customer");

                    b.Navigation("SourceBasketTransaction");
                });
